...
class VoiceCloneRequest(BaseModel):
    ...
    voice_prompt_file: Optional[str] = Field(
        default=None,
        description="Base64-encoded voice prompt .pt file generated by /audio/voice-clone/prompt.",
    )
    ...
    deterministic: bool = Field(
        default=False,
        description="If True, disable sampling for deterministic output.",
    )
    language: Optional[str] = Field(
        default="Auto",
...
class VoiceClonePromptRequest(BaseModel):
    """Request schema for voice clone prompt creation endpoint."""
    ...
    x_vector_only_mode: bool = Field(
        default=False,
        description="If True, save x-vector only prompt. If False, save ICL prompt (ref_text required).",
    )
